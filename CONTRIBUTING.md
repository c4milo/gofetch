...
* In Github, fork `https://github.com/c4milo/gofetch` to your own account
* Get the package using "go get": `go get github.com/c4milo/gofetch`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/c4milo/gofetch`
* Add a git remote pointing to your own fork: `git remote add downstream git@github.com:<your_account>/gofetch.git`
